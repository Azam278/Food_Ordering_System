              ...
              <div class="card-body p-5">  
                ...
                <div class="row g-4 needs-validation" novalidate>  
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="email" class="form-control form-control-lg @error('admin.name') is-invalid @enderror" wire:model.debounce.500ms="admin.name" placeholder="Enter your name">
                ...
                <div class="row g-4 needs-validation" novalidate>  
                  <div class="col-12">
                    ...
                    <div class="input-group has-validation">
                      <span class="input-group-text bg-light"><i class="bi bi-envelope"></i></span>
                      <input type="email" class="form-control form-control-lg @error('admin.email') is-invalid @enderror" wire:model.debounce.500ms="admin.email" placeholder="Enter your email">
                  ...
                  <div class="col-12">
                    ...
                    <div class="input-group has-validation">
                      ...
                      <input type="password" name="password" class="form-control form-control-lg @error('admin.password') is-invalid @enderror" wire:model.debounce.500ms="admin.password" placeholder="Enter your password">
                  ...
                  <div class="col-12 text-center mt-3">
                    <p class="mb-0">Already have an account? <a href="{{route('admin.login')}}" class="text-decoration-none fw-semibold">Log In</a></p>
                  </div>
                </div>  
              </div>
            </div>
