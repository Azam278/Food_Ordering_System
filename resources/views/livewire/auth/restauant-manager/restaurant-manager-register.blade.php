        ...
        <div class="card mb-3 shadow-lg border-0 rounded-4">  
            ...
            <div class="row g-4 needs-validation" novalidate>  
                <div class="col-12">
                    ...
                    <input type="email" class="form-control form-control-lg @error('managerRestaurant.name') is-invalid @enderror" wire:model.debounce.500ms="managerRestaurant.name" placeholder="Enter your name">
            ...
            <div class="row g-4 needs-validation" novalidate>  
                ...
                <div class="input-group has-validation">
                    <span class="input-group-text bg-light"><i class="bi bi-envelope"></i></span>
                    <input type="email" class="form-control form-control-lg @error('managerRestaurant.email') is-invalid @enderror" wire:model.debounce.500ms="managerRestaurant.email" placeholder="Enter your email">
                ...
                <div class="input-group has-validation">
                    ...
                    <input type="password" name="password" class="form-control form-control-lg @error('managerRestaurant.password') is-invalid @enderror" wire:model.debounce.500ms="managerRestaurant.password" placeholder="Enter your password">
                ...
                <p class="mb-0">Already have an account? <a href="{{route('manager.login')}}" class="text-decoration-none fw-semibold">Log In</a></p>
                </div>
            </div>  
            </div>
        </div>
